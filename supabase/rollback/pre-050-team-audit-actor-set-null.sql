-- Rollback for 050_team_audit_actor_set_null.sql.
--
...
--
-- 050 changed one foreign key's referential action and nothing else. This
...
--
-- Independent of every other rollback here. 044, 045, 046, 049 and 050 touch
-- five disjoint sets of objects.
--
-- WHAT IT CANNOT UNDO: rows whose actor_id was already set to null by a
-- deletion that happened while 050 was live. The link is gone; restoring the
...
-- 050's own header maps them. Restoring this one puts back the specific
