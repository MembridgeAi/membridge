...
-- created_by = auth.uid())`); migrations/035_drop_projects_insert.sql dropped it
...
-- See 035's header for the measurements, and supabase/rollback/
-- pre-035-projects-insert.sql for the exact prior body if it ever has to return.
