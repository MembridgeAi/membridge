...
| **#42** | Self-serve deletion has **no user-facing surface**. Backend + RPC + 26 tests exist; nothing in the repo calls `/api/team/my-data` or `delete-my-data`. Check against what the security page claims. |
...
| **#39** | Codex capture is materially weaker and nothing discloses it. Disclose, or close it with a distillation pass. |
