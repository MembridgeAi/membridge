...
function settleRows(rows, now, buildOpenServe, knownServeIds, knownHoldoutKeys, knownNotesKeys) {
  ...
  return { avoidedDelta, holdoutDelta, notesDelta, newOpenServes, retained, newHoldoutKeys, newNotesKeys };
}

module.exports = {
  settleRows, groupServeRows, byteSizeOf, estimateReadTokens,
  zeroAvoided, zeroHoldout, zeroNotes, PENDING_CONFIRM_GRACE_MS,
};
