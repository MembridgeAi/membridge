...
// (no UI here). See supabase/migrations/023_project_access_and_audit.sql for
...
module.exports = { readAccess, writeAccess, writeAccessDefault, accessMatrix, readAudit, writeAudit, AccessError, isManagerRole };
