...
// Compaction threshold. One line is ~120-200 bytes; heavy use (100 searches
// a day serving 20 results each) is ~30KB/day, so 4MB is months of headroom.
...
module.exports = {
  record, countsFor, readCounts, logPath, basePath,
