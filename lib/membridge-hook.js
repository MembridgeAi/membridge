...
// `notes-session-start` / `notes-post-compact` run the teammate-notes hooks
// (lib/hooks-notes.js); anything else is the Stop-hook entry point.
...
else if (argv[0] === 'notes-post-compact') require('./hooks-notes').runPostCompact();
else hooks.runStop();
