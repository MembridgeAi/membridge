...
const DEFAULT_CONFIG = {
  ...
  maxReadEvents: 2000,
  // Edits are budgeted apart from the narrative pool (prompts, summaries,
  // todos) so a delegating session cannot evict a teammate's history. See
  // DEFAULT_EDIT_EVENTS in lib/digest.js.
  maxEditEvents: 2000,
...
module.exports = {
  teamRowsFor, LIVE_WINDOW_MS, isLive, publicSource,
