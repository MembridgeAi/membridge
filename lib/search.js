...
// opts.minTerms threads straight through to scoreEntry (see there) — this
// function holds no fallback policy of its own, that lives with the caller
// (lib/mcp.js searchMemory), so this module stays pure and side-effect-free.
