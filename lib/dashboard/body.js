...
<div class="overlay" id="addOverlay">
  <div class="modal">
    <h3>Add a project</h3>
    <p class="m-help">These are folders your AI tools have already worked in. Pick the ones
    MemBridge should watch — no paths to type.</p>
    <div id="addDiscovered"></div>
    <p class="m-help" style="margin-top:14px">Not listed? Paste the full path instead.</p>
...
<div id="view-setup"><div id="setupRoot"></div></div>

<div id="view-upgrade"><div id="upgradeRoot"></div></div>
