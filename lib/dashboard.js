...
<div id="view-settings">
  <div class="inner">
    ...
    <div class="card">
      ...
      <p class="m-help" style="margin-top:10px">Also inject the same shared memory into other tools' context files (off by default):</p>
      <label class="radio" style="width:auto; display:inline-flex">
        <input id="stTargetGemini" type="checkbox"><span>Gemini CLI — GEMINI.md</span>
      </label>
      <label class="radio" style="width:auto; display:inline-flex">
        <input id="stTargetCursor" type="checkbox"><span>Cursor — .cursor/rules/membridge.mdc</span>
      </label>
      <label class="radio" style="width:auto; display:inline-flex">
        <input id="stTargetWindsurf" type="checkbox"><span>Windsurf — .windsurfrules</span>
      </label>
      <label class="radio" style="width:auto; display:inline-flex">
        <input id="stTargetCopilot" type="checkbox"><span>GitHub Copilot — .github/copilot-instructions.md</span>
      </label>
      <div class="st-btns">
...
function renderSettings(d) {
  ...
  var ext = d.extraTargets || {};
  document.getElementById('stTargetGemini').checked = !!ext.gemini;
  document.getElementById('stTargetCursor').checked = !!ext.cursor;
  document.getElementById('stTargetWindsurf').checked = !!ext.windsurf;
  document.getElementById('stTargetCopilot').checked = !!ext.copilot;
...
document.getElementById('stSaveSync').onclick = function () {
  ...
  var extraTargets = {
    gemini: document.getElementById('stTargetGemini').checked,
    cursor: document.getElementById('stTargetCursor').checked,
    windsurf: document.getElementById('stTargetWindsurf').checked,
    copilot: document.getElementById('stTargetCopilot').checked,
  };
  postSettings({ intervalSec: n, targets: t, extraTargets: extraTargets }, 'stSyncResult', 'Saved — applies from the next check');
};
