...
const { setupCss, setupJs } = require('./dashboard/setup');
const { upgradeCss, upgradeJs } = require('./dashboard/upgrade');
...
function dashboardPage() {
  ...
  // matches the membridge.app site logo and app/assets/brand/membridge-app-icon.svg.
...
<style>
${dashboardStyles(ICON_DATAURI, teamCss, setupCss, upgradeCss)}
</style>
</head>
<body>
${dashboardBody(MARK_WHITE)}
<script>
${dashboardClient(MARK_WHITE, teamJs, setupJs, upgradeJs)}
</script>
</body>
</html>`;
}
