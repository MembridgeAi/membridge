'use strict';
// Self-serve deletion of your OWN synced entries: migration 028's two RPCs,
...
async function main() {
  ...
  try {
    ...
    // 028's header calls this out as the tempting, catastrophic tidy-up:
    ...
    // reports what it removed PER PROJECT (028 §3), so a project it emptied
    ...
    // 028 §1 scopes the DELETE policy on author_id ALONE. Someone who has left
